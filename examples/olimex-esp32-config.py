# library
from prometheus_express import check_network, parse_file, start_http_server, CollectorRegistry, Counter, Gauge, Router
...
def main():
    ...
    while True:
        ...
        if True:  # bme.get_sensor_data():
            metric_g.labels(location, 'bme680').set(0)  # bme.data.temperature)
